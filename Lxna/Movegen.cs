...
namespace Lxna {
    public class Movegen {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void GenerateMovesNonAlloc(Board board, ref Span<int> moveList) {
            int source, target, currMoveIndex = 0;
            ulong attacks;
                        ...
                        while (bitboard > 0) {
                            ...
                            if (!(target < (int)Square.A8) && BitboardHelper.GetBitAtIndex(target, board.Blockers[(int)SideToMove.Both]) <= 0) {
                                if (source >= (int)Square.A7 && source <= (int)Square.H7) {
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.WhiteQueen, 0, 0, 0, 0);
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, 0, 0, 0, 0, 0);
                                    ...
                                    if (source >= (int)Square.A2 && source <= (int)Square.H2 &&
                                        ...
                                        moveList[currMoveIndex++] = Move.EncodeMove(source, target - 8, piece, 0, 0, 1, 0, 0);
                                    }
                                }
                            }
                            ...
                            while (attacks > 0) {
                                ...
                                if (source >= (int)Square.A7 && source <= (int)Square.H7) {
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.WhiteQueen, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.WhiteRook, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.WhiteBishop, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.WhiteKnight, 1, 0, 0, 0);
                                }
                            
                                else {
                                    // Console.WriteLine("White Pawn Capture: {0,2}{1,2}", (Square)source, (Square)target);
                                    
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, 0, 1, 0, 0, 0);
                                }
                            ...
                            if (board.EnPassant != Square.NoSquare) {
                                ...
                                if (enPassantAttacks > 0) {
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, targetEnPassant, piece, 0, 1, 0, 1, 0);
                                }
                            }
                        ...
                        if ((board.Castling & (int)Castle.WhiteKingside) > 0) {
                            if (BitboardHelper.GetBitAtSquare(Square.F1, board.Blockers[(int)SideToMove.Both]) <= 0 &&
                                ...
                                if (!board.IsSquareAttacked(Square.E1, SideToMove.Black) &&
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove((int)Square.E1, (int)Square.G1, piece, 0, 0, 0, 0, 1);
                                }
                            }
                        }
                        ...
                        if ((board.Castling & (int)Castle.WhiteQueenside) > 0) {
                            if (BitboardHelper.GetBitAtSquare(Square.D1, board.Blockers[(int)SideToMove.Both]) <= 0 &&
                                ...
                                if (!board.IsSquareAttacked(Square.E1, SideToMove.Black) &&
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove((int)Square.E1, (int)Square.C1, piece, 0, 0, 0, 0, 1);
                                }
                            }
                        }
                    }
                        ...
                        while (bitboard > 0) {
                            ...
                            if (!(target > (int)Square.H1) && BitboardHelper.GetBitAtIndex(target, board.Blockers[(int)SideToMove.Both]) <= 0) {
                                if (source >= (int)Square.A2 && source <= (int)Square.H2) {
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackQueen, 0, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackRook, 0, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackBishop, 0, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackKnight, 0, 0, 0, 0);
                                }
                            ...
                            while (attacks > 0) {
                                ...
                                if (source >= (int)Square.A2 && source <= (int)Square.H2) {
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackQueen, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackRook, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackBishop, 1, 0, 0, 0);
                                    moveList[currMoveIndex++] = Move.EncodeMove(source, target, piece, (int)Piece.BlackKnight, 1, 0, 0, 0);
                                }
                        ...
                        if ((board.Castling & (int)Castle.BlackKingside) > 0) {
                            if (BitboardHelper.GetBitAtSquare(Square.F8, board.Blockers[(int)SideToMove.Both]) <= 0 &&
                                ...
                                if (!board.IsSquareAttacked(Square.E8, SideToMove.White) &&
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove((int)Square.E8, (int)Square.G8, piece, 0, 0, 0, 0, 1);
                                }
                            }
                        }
                        ...
                        if ((board.Castling & (int)Castle.BlackQueenside) > 0) {
                            if (BitboardHelper.GetBitAtSquare(Square.D8, board.Blockers[(int)SideToMove.Both]) <= 0 &&
                                ...
                                if (!board.IsSquareAttacked(Square.E8, SideToMove.White) &&
                                    ...
                                    moveList[currMoveIndex++] = Move.EncodeMove((int)Square.E8, (int)Square.C8, piece, 0, 0, 0, 0, 1);
                                }
                            }
                        }
                    }
            ...
            moveList = moveList.Slice(0, currMoveIndex);
        }
