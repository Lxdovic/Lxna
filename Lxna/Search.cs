...
public class Search {
    ...
    //         bool isWhite = piece < Piece.BlackPawn;
    //         int side = isWhite ? 1 : -1;
    //
    //         while (bitboard > 0) {
    ...
    //                 
    //                 middlegame += penalty * side;
    //                 endgame += penalty * side;
    //                 
    ...
    //                 }
    //                 
    //                 if ((WhitePassedMasks[index] & _board.Bitboards[isWhite ? (int)Piece.BlackPawn : (int)Piece.WhitePawn]) == 0) {
